...
export function getRankInfo(rank) {
  const ranks = {
    ...
    plata: { name: 'Plata', commission: 18, color: '#808080', type: 'auto', salesNeeded: 50, nextLevel: { name: 'Oro', rate: 15, salesNeeded: 100 } },
    oro: { name: 'Oro', commission: 15, color: '#DAA520', type: 'auto', salesNeeded: 100, nextLevel: null },
    platino: { name: 'Platino', commission: 12, color: '#5AABAB', type: 'manual', salesNeeded: 250, nextLevel: null },
